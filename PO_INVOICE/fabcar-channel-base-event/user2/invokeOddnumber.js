...
var channel = fabric_client.newChannel('privatechannel2');
var peer = fabric_client.newPeer('grpc://localhost:8051');
channel.addPeer(peer);
var channel_event_hub =channel.getChannelEventHub("localhost:8051")
...
setInterval(function() {
  ...
  console.log("Random money!! = "+ oddnumber +" , sum Random money : "+fullmoney);
  invoke(oddnumber)
}, 1000*5);
