...
const chaincodeEventName = "addmoney"
    ...
    ChannelEventArray.forEach(ChannelEvent => {
        ...
        (event, block_num, txnid, status) => {
           // console.log(event)
            ...
            console.log("addmoney  : "+money+"   in block number : "+block_num)
        },
        (err) => {
