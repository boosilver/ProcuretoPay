...
docker-compose -f docker-compose.yml up -d ca1.example.com ca2.example.com ca3.example.com ca4.example.com orderer.example.com peer0.org1.example.com  peer0.org2.example.com  peer0.org3.example.com peer0.org4.example.com  cli  couchdb
# if you want to start peer1.org1.example.com ,peer1.org2.example.com you can copy into line 15 
